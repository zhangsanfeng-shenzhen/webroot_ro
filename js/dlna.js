...
function getMoreFolder(folderId, subData) {
    ...
    if ($("#" + folderId).html() !== "") {
        ...
        //显示搜索图标
        $(".folder-scan").css("background", "url(/img/scan.gif?6b8abe30e3b29fd3d1c92d44bace3e01) 0 no-repeat");
