...
function changeImg(imgID, powerValue) {
    ...
    if (powerValue == "low") {
        $imgDom.attr("src", "../img/icon-power-gray1.png?6b8abe30e3b29fd3d1c92d44bace3e01");
    } else if (powerValue == "middle") {
        $imgDom.attr("src", "../img/icon-power-gray2.png?6b8abe30e3b29fd3d1c92d44bace3e01");
    } else {
        $imgDom.attr("src", "../img/icon-power.png?6b8abe30e3b29fd3d1c92d44bace3e01");
    }
}
