...
function hideEditNameArea(rowEle, devName) {
    $(rowEle).find(".dev-name").text(devName).append('<img class="edit-btn none edit-btn-txt-append" src="img/edit.png?6b8abe30e3b29fd3d1c92d44bace3e01" />');
}
...
function addList() {
    ...
    str += "<tr>";
    str += "<td class='dev-name fixed edit-td' title='" + "'><span class='dev-name-txt dev-target'>" + "</span><img class='edit-btn none edit-btn-txt-append' src='img/edit.png?6b8abe30e3b29fd3d1c92d44bace3e01' /></td>";
